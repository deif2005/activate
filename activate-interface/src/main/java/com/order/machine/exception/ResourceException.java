...
public class ResourceException extends RuntimeException {
    ...
    public ResourceException(String rtnCode){
        this.rtnCode = rtnCode;
    }

    public ResourceException(String rtnCode, String message) {
        this.rtnCode = rtnCode;
        this.msg = message;
    }

    public ResourceException(String rtnCode, String message, String developMsg) {
        this(rtnCode, message);
        this.developMsg = developMsg;
    }

    public ResourceException(String rtnCode, String message, Throwable cause) {
        this(rtnCode, message);
        this.developMsg = cause.getMessage();
    }

    public ResourceException(String rtnCode, String message, String developMsg, String uri) {
